...
import { baseLocale, getLocale, isLocale, type Locale, locales, setLocale } from '@/paraglide/runtime';

export { baseLocale, getLocale, isLocale, type Locale, locales, m, setLocale };
